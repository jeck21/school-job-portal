-- Add verified_only parameter to search_jobs RPC for server-side verified filter.
-- Replaces client-side post-filtering which caused wrong counts and broken pagination.
...
BEGIN
  ...
  WHERE j.is_active = true
    ...
    -- Verified-only filter: only show jobs claimed by a district
