...
|----------|-------------|------------|-------------------|
| AI-based freshness analysis accuracy | DATA-12 | Claude Haiku output varies; needs human review of edge cases | Run freshness checker on 10 known-expired postings, verify ≥80% correctly flagged |
